...
var synth_params = {
	...
	filterEnvDecayTime: 0.1,
	filterEnvSustainLevel: 0.5,
	filterEnvReleaseTime: 0.1,
	
	ampEnvAttackTime: 0.5,
	ampEnvDecayTime: 1,
	ampEnvSustainLevel: 0.5,
	ampEnvReleaseTime: 1
};

var delay_params = {
	delayTime: 1,
	delayFeedbackGain: 0.5,
	delayWetDry: 0.5
}
var reverb_params = {
	reverbWetDry: 0.5
...
// reverb
	...
	gui_reverb_time.on('*',function(data) {
		reverb.updateParams('reverb_WD', data.value);
	});
	// Keyboard 	
